...
import in.shriyansh.streamify.custumUI.FlippingView;
import in.shriyansh.streamify.custumUI.ImageWallView;
...
public class VideoWallDemoActivity extends Activity implements
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    thumbnailView.initialize(Constants.YOUTUBE_DEVELOPER_KEY, this);
